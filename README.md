...
| :--- | :---: | :--- |
| **Total Account Value** | $4.9500 USD | Base Starting Asset: $3.00 |
| **Net Return (%)** | +65.00% | Tracked via live ledger logic |
| **Active Floating Leverage** | 500x Cross | Maximum Risk Limit: 1% per play |
| **Win/Loss Ratio** | 6 / 5 (54.5%) | Profit Factor: Multi-stage execution |
